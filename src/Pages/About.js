      ...
      <div className="responsive-container-block leftSide">
          <div className='container-About'>
           ...
           <p className="text-blk subHeading">
               A blog website is an online platform where individuals or organizations publish articles, stories, tutorials, opinions, and other types of content in a chronological format. It serves as a digital diary or journal, often featuring personal insights, professional advice, industry news, or hobbies and interests. Key features typically include:
            </p>
          </div>
        </div>
